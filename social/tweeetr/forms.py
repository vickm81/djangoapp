...
from .models import Tweeet, Profile
from django.contrib.auth.forms import UserCreationForm
from django.contrib.auth.models import User


class ProfilePicForm(forms.ModelForm):
    profile_bio = forms.CharField(label='profile bio', widget=forms.widgets.Textarea(
        attrs={"placeholder":"",
               "class":"form-control"}))
    website_link = forms.CharField(label="", widget=forms.TextInput(
...
class Tweeet_form(forms.ModelForm):
